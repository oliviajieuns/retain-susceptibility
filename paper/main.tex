...
\keywords{machine unlearning, large language models, collateral damage,
damage channels, retain-set selection, randomized sensitivity,
backward-free profiling, unlearning evaluation}
